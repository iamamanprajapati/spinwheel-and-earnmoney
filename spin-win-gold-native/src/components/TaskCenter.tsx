...
const getTaskIcon = (type: string, icon: string) => {
  switch (type) {
    case 'watch_ad':
      return <Ionicons name="play-circle" size={24} color={COLORS.blue400} />;
    case 'follow':
      return <Ionicons name="heart" size={24} color={COLORS.pink500} />;
    case 'invite':
      return <Ionicons name="people" size={24} color={COLORS.green400} />;
    case 'install':
      return <Ionicons name="star" size={24} color={COLORS.yellow400} />;
    default:
      return <Ionicons name="gift" size={24} color={COLORS.purple600} />;
  }
};
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.comingSoon}>
        ...
        <View style={styles.comingSoonIcons}>
          <Ionicons name="rocket-outline" size={28} color={COLORS.slate600} />
          <Ionicons name="game-controller-outline" size={28} color={COLORS.slate600} />
