...
const getTaskIcon = (type: string) => {
  switch (type) {
    case 'watch_ad':
      return <Ionicons name="play-circle" size={22} color={COLORS.blue400} />;
    case 'follow':
      return <Ionicons name="heart" size={22} color={COLORS.pink500} />;
    case 'invite':
      return <Ionicons name="people" size={22} color={COLORS.green400} />;
    case 'install':
      return <Ionicons name="star" size={22} color={COLORS.yellow400} />;
    default:
      return <Ionicons name="gift" size={22} color={COLORS.purple600} />;
  }
};
            ...
            >
              ...
              >
                <View style={styles.playButtonContent}>
                  <Ionicons name="play" size={16} color={COLORS.indigo600} />
        ...
        />
          ...
          <View style={styles.spinNavWrapper}>
            ...
            >
              ...
              >
                <MaterialCommunityIcons name="tire" size={28} color={COLORS.slate950} />
              </LinearGradient>
            </TouchableOpacity>
          </View>
...
const NavBtn: React.FC<NavBtnProps> = ({ active, onPress, iconName, label }) => {
  const getIconComponent = () => {
    ...
    switch (iconName) {
      case 'home':
        return <Ionicons name={active ? "home" : "home-outline"} size={iconSize} color={iconColor} />;
      case 'list':
        return <Ionicons name={active ? "checkbox" : "checkbox-outline"} size={iconSize} color={iconColor} />;
      case 'wallet':
        return <Ionicons name={active ? "wallet" : "wallet-outline"} size={iconSize} color={iconColor} />;
      case 'trophy':
        return <Ionicons name={active ? "trophy" : "trophy-outline"} size={iconSize} color={iconColor} />;
      default:
